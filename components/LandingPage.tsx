    ...
    <div className="w-full">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6 pt-20">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-white tracking-tighter leading-[1.1] mb-8 animate-fade-in-up">
            Redefining Sustainable <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-electricGreen to-cyberCyan drop-shadow-[0_0_15px_rgba(0,245,160,0.3)]">
              Lending with AI
            </span>
          </h1>
      ...
      <section className="py-32 px-6">
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <GlassCard key={idx} delay={idx * 0.15} className="group hover:-translate-y-2 cursor-default">
        ...
        <div className="max-w-[1200px] mx-auto text-center mb-20">
          ...
          <div className="relative mt-12 mx-auto max-w-[1000px] group cursor-pointer" onClick={onEnter}>
            <div className="rounded-2xl border border-white/10 bg-navy/80 overflow-hidden shadow-2xl transition-transform duration-700 group-hover:scale-[1.01] group-hover:border-electricGreen/30">
              ...
              <div className="p-4 bg-navy flex gap-4">
                <div className="w-1/4 h-64 bg-white/5 rounded-lg border border-white/5" />
                <div className="flex-1 space-y-4">
                  <div className="h-12 bg-electricGreen/10 rounded-lg border border-electricGreen/20" />
                  <div className="grid grid-cols-2 gap-4">
                    <div className="h-32 bg-cyberCyan/10 rounded-lg border border-cyberCyan/20" />
      ...
      <section className="py-32 px-6 space-y-40">
        {[
          ...
          <div key={idx} className={`max-w-[1200px] mx-auto flex flex-col ${feature.imgSide === 'right' ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-20`}>
      ...
      <section className="px-6 py-20">
        <div className="max-w-[1200px] mx-auto rounded-3xl bg-gradient-to-br from-emerald/40 to-navy p-12 md:p-24 text-center relative overflow-hidden">
